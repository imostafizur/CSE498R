...
def showResultOfBrainStroke(request):
    ...
    en = SaveStrokeEnquiry(gender=gender,age=age,hypertension=hypertension,heart_disease = heart_disease, married= married,work_type = work_type,
                             residence_type =residence_type, avg_glucose_level= avg_glucose_level, bmi=bmi, smoking_status = smoking_status,result=result)
    en.save()
